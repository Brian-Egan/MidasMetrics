...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { fb_fans: @network.fb_fans, fb_id: @network.fb_id, name: @network.name }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { fb_fans: @network.fb_fans, fb_id: @network.fb_id, name: @network.name }
    assert_redirected_to network_path(assigns(:network))
  end
